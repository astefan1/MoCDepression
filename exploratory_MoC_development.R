...
lm_es_noInt <- summary(lm(ESscore ~ treat + time, data = ESdata_long))
lm_es_withInt <- summary(lm(ESscore ~ treat * time, data = ESdata_long))
...
bayesian_es_noInteraction <- brm(ESscore ~ treat + time, data = na.omit(ESdata_long), iter=10000, sample_prior="yes", prior=prior)
bayesian_es_Interaction <- brm(ESscore ~ treat * time, data = na.omit(ESdata_long), iter=10000, sample_prior="yes", prior=prior)
...
coef_tests_ES_noInt <- round(cbind(coefficients(lm_es_noInt), BF01 = c(NA, bf_es_noInt$hypothesis$Evid.Ratio)), 3)
coef_tests_ES_Int <- round(cbind(coefficients(lm_es_withInt), BF01 = c(NA, bf_es_withInt$hypothesis$Evid.Ratio)), 3)
...
lm_cr_noInt <- summary(lm(CRscore ~ treat + time, data = CRdata_long))
lm_cr_withInt <- summary(lm(CRscore ~ treat * time, data = CRdata_long))
...
bayesian_cr_noInteraction <- brm(CRscore ~ treat + time, data = na.omit(CRdata_long), iter=10000, sample_prior="yes", prior=prior)
bayesian_cr_Interaction <- brm(CRscore ~ treat * time, data = na.omit(CRdata_long), iter=10000, sample_prior="yes", prior=prior)
...
coef_tests_CR_noInt <- round(cbind(coefficients(lm_cr_noInt), BF01 = c(NA, bf_cr_noInt$hypothesis$Evid.Ratio)), 3)
coef_tests_CR_Int <- round(cbind(coefficients(lm_cr_withInt), BF01 = c(NA, bf_cr_withInt$hypothesis$Evid.Ratio)), 3)
...
lm_ax_noInt <- summary(lm(AXscore ~ treat + time, data = AXdata_long))
lm_ax_withInt <- summary(lm(AXscore ~ treat * time, data = AXdata_long))
...
bayesian_ax_noInteraction <- brm(AXscore ~ treat + time, data = na.omit(AXdata_long), iter=10000, sample_prior="yes", prior=prior)
bayesian_ax_Interaction <- brm(AXscore ~ treat * time, data = na.omit(AXdata_long), iter=10000, sample_prior="yes", prior=prior)
...
coef_tests_AX_noInt <- round(cbind(coefficients(lm_ax_noInt), BF01 = c(NA, bf_ax_noInt$hypothesis$Evid.Ratio)), 3)
coef_tests_AX_Int <- round(cbind(coefficients(lm_ax_withInt), BF01 = c(NA, bf_ax_withInt$hypothesis$Evid.Ratio)), 3)
...
lm_av_noInt <- summary(lm(AVscore ~ treat + time, data = AVdata_long))
lm_av_withInt <- summary(lm(AVscore ~ treat * time, data = AVdata_long))
...
bayesian_av_noInteraction <- brm(AVscore ~ treat + time, data = na.omit(AVdata_long), iter=10000, sample_prior="yes", prior=prior)
bayesian_av_Interaction <- brm(AVscore ~ treat * time, data = na.omit(AVdata_long), iter=10000, sample_prior="yes", prior=prior)
...
coef_tests_AV_noInt <- round(cbind(coefficients(lm_av_noInt), BF01 = c(NA, bf_av_noInt$hypothesis$Evid.Ratio)), 3)
coef_tests_AV_Int <- round(cbind(coefficients(lm_av_withInt), BF01 = c(NA, bf_av_withInt$hypothesis$Evid.Ratio)), 3)
